...
summary(entertainment$shares)

kable(table(entertainment2$day, entertainment2$n_tokens_title), caption = "Counts for Number of Words in the Title per Day of the Week")
